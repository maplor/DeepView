...
def Skoda(window_size, step):
    ...
    if os.path.exists(data_path):
        ...
        train_x, train_y = generate_data(current_path)
...
def generate_data(current_path):
    ...
    x_train, y_train  = get_data(all_data)
...
# reference
# https://github.com/Navidfoumani/Series2Vec/blob/d0d3c851384457c29129ed9a97c5a26721be2d37/Dataset/Benchmarks/Skoda/Skoda_Loader.py

Skoda(window_size=300, step=300)
print('')