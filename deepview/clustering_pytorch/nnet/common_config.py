...
def get_criterion(p):
    ...
    #     from losses import ConfidenceBasedCE
...
def get_optimizer(p_opti, model, cluster_head_only=False):
    ...
    if p_opti == 'sgd':
        ...
        # 'lr': 0.01,
        # }
        optimizer = torch.optim.SGD(params, nesterov=False,weight_decay=0.0001,momentum=0.9,lr=0.01)
        ...
        optimizer = torch.optim.Adam(params, nesterov=False,weight_decay=0.0001,momentum=0.9,lr=0.01)
