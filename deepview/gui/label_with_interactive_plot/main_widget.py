...
class LabelWithInteractivePlot(LabelControlsMixin, VideoControlsMixin, LayoutMixin, SelectionAreaMixin, DataControlsMixin, SettingsAreaMixin, ComputeMixin, QWidget):
