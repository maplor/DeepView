...
class TrainNetwork(DefaultTab):
    ...
    def _set_page(self):
        ...
        # ---------
        self.main_layout.addWidget(_create_label_widget("Split dataset", "font:bold"))
    ...
    def _generate_layout_attributes(self, layout):
        ...
        self.display_iters_spin.setValue(3)
        ...
        self.save_iters_spin.setValue(4)
        ...
        self.max_iters_spin.setValue(5)
    ...
    def _generate_layout_attributes_dataset(self, layout):
        ...
        nnet_label = QtWidgets.QLabel("select test set")
        self.net_choice = QtWidgets.QComboBox()
        nets = ['A', 'B']  # a string list, string is model names
        # todo: select nets from folders
        self.net_choice.addItems(nets)
        self.net_choice.setCurrentText("A")
        self.net_choice.currentTextChanged.connect(self.log_net_choice)

        layout.addWidget(nnet_label, 0, 8)
        # ---------
